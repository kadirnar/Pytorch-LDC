    ...
    if is_linux:
        ...
        config = {
            ...
            "BRIND": {
                ...
                "test_list": "test_pair.lst",
                "data_dir": "/home/kadir/AI/paper/BRIND",  # mean_rgb
                "yita": 0.5,
            },
            "BSDS300": {
                "img_height": 512,  # 321
...
class TestDataset(Dataset):
    def __init__(self, data_root, test_data, mean_bgr, img_height, img_width, test_list=None, arg=None):
...
class BipedDataset(Dataset):
    ...
    def transform(self, img, gt):
        ...
        gt /= 255.0  # for LDC input and BDCN
